...
def Verify_user_can_be_created_rest_post_api_call():
...
def Verify_user_can_be_updated_rest_put_api_call():
...
def Verify_user_can_be_fetched_using_rest_get_api_call():
...
def Verify_user_can_be_deleted_using_rest_delete_api_call():
